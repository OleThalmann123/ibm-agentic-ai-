/**
 * Vercel matched /api/langsmith/runs/batch (mehrere Segmente) nicht zuverlässig über
 * api/langsmith/[...path].ts → NOT_FOUND, daher eigene Route unter runs/.
 * Deckt batch, multipart, runs/:id, runs/query, … ab.
