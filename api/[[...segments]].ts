/**
 * Ein optionaler Catch-All unter /api/*, damit /api/langsmith/runs/batch zuverlässig
 * ankommt (Vercel matched api/langsmith/[...path] nicht zuverlässig für mehrere Segmente).
 *
 * Nur Pfade mit erstem Segment "langsmith" werden proxied; sonst 404.
 * Spiegel: apps/prototyp-1-v2/api/[[...segments]].ts
 */
...
/** Fallback, falls Vercel segments-Query leer lässt. */
